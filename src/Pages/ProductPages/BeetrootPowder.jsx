...
const BeetrootPowder = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-8">
        <img src="/assets/Assets/beetroot/beetrootPowder.png" alt='Beetroot Powder Banner' loading="lazy" className="w-full rounded-lg" />
      ...
      <div className="mt-8">
        <img src="" alt="Beetroot Powder" className="w-full rounded-lg" loading="lazy" />
